...
const CoronaUI = React.memo(function CoronaUI({ seekAlert, isUnderAttack }) {
  return (
...
const CoronaHowler = React.memo(function CoronaHowler({
  isUnderAttack,
  seekAlert,
}) {
...
export const CoronaRenderer = React.memo(function CoronaRenderer(props) {
  const {
    onDeathAnimEnd,
    isSeeking,
    isPreattacking,
...
const CoronaShadow = React.memo(function CoronaShadow(props) {
